...
$params = @{
    ...
    Engine        = Get-ValueOrDefault                    $teamcityParameters['odsapi.build.engine']         'PostgreSQL'
    ...
    RunDotnetTest = Get-ValueOrDefault (ConvertTo-Boolean $teamcityParameters['odsapi.build.runDotnetTest']) $false
    ...
    UsePlugins    = Get-ValueOrDefault (ConvertTo-Boolean $teamcityParameters['odsapi.build.usePlugins'])    $true
